...
def main(game, nn_config, reinforce_config):
    ...
    trainer.train_best_response(nn_policy, 1 - nn_player, num_episodes=1000)

    neural_br_tab_policy = neural_policies.nn_to_tabular_policy(
        game, neural_br_policy, 1 - nn_player
    )
    policies = (
    ...
    print(neural_br_tab_policy.action_probability_array)
